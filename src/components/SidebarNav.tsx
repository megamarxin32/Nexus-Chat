...
export const SidebarNav: React.FC<SidebarNavProps> = ({
  ...
  return (
    <aside
      ...
      className="w-16 md:w-20 flex flex-col items-center justify-between py-4 border-r transition-colors z-20 shrink-0 select-none"
      style={{
    ...
    >
      ...
      <div className="flex flex-col items-center gap-3 w-full px-2">
        ...
        <button
          ...
          className="flex items-center justify-center w-10 h-10 rounded-xl text-slate-400 hover:text-slate-200 hover:bg-slate-800/40 transition-all"
